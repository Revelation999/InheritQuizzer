...
public class Generate
	{
		...
		public static void generate()
		{
			...
			String answer[] = {"The star lives.", "The star dies.", "The dwarf star lives.", "The dwarf star dies.", "ERROR"};
					...
					for (int b = 0; b < stem.length; b++)
						{
							...
							switch (a)
							{
								...
								case 2:{if (b==0) an = answer[0]; else if (b==1) an = answer[3]; else if (b==2) an = answer[4];break;}
